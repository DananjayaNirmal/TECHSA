...
<div>
    <form method = "POST">
        <h3 style = "background-color:#A9A9A9; margin-left:-50px; padding-left:50px;">Update User details</h3>
        <br>
    ...
    <div>
        ...
        <br>
        <h3 style = "margin-left:-50px; padding-left:50px; background-color:#A9A9A9;">Update Address Details</h3>
        <br>
        ...
        <input type = "submit" name = "udt" placeholder = "Add" style ="margin-bottom:20px; border:none; background-color:green; padding:5px 10px 5px 10px; border-radius:2px;">
